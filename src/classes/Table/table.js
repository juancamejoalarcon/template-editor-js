    ...
    new IfConditionComponent({ 
      ...
      props: { 
        ...
        onRemove: () => {
          ...
          row.classList.remove('tc-if-condition')
        },
        conditionChanged: (condition) => {
          ifConditionContainer.setAttribute('condition', condition);
        }
      } 
    });
    ifConditionContainer.classList.add('if')
    ifConditionContainer.setAttribute('contenteditable', 'false')

    $.insertBefore(ifConditionContainer, row.firstElementChild);
